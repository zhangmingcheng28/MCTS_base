...
class AirspaceState():
    ...
    def next_state(self, action):
        ...
        # if dev_x == 0.0 and dev_y ==0.0 and dev_z ==0.0:
        #     print("dev=0 check")
...
if __name__ == "__main__":
    ...
    for ea_eps in range(args.episodes):
        ...
        intruder_uav_end = [259.47, 145.66, 35]
        ...
        occupied_intruder_start, intruder_uav_simulation_start = is_point_in_occupied_cell(intruder_uav_start, dx, dy, dz, occupancy_dict)
        occupied_intruder_end, intruder_uav_simulation_end = is_point_in_occupied_cell(intruder_uav_end, dx, dy, dz, occupancy_dict)
        ...
        intruder_desired = desired_velocity(intruder_uav_simulation_start, intruder_uav_simulation_end, intruder_speed)
        ...
        for step in range(args.steps):
            ...
            if best_child is not None:
                ...
                # TO DO: relative distance compared with all other intruders
            ...
            if current_node.state.terminal():
                ...
                # host_uav_simulation_start, host_uav_simulation_end)
        ...
        episode_record[ea_eps] = {'eps_traj': [host_trajectory, intruder_trajectory],
